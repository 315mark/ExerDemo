...
import com.cvsong.study.mobilehelper.data.constants.AppConstants;
...
public final class APPLogUtils {
    ...
    public static class Builder {
        public Builder() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && AppContextUtils.getContext().getExternalCacheDir() != null)
                defaultDir = AppContextUtils.getContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                defaultDir = AppContextUtils.getContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }

        public Builder setLogSwitch(final boolean logSwitch) {
            APPLogUtils.sLogSwitch = logSwitch;
            return this;
        }

        public Builder setConsoleSwitch(final boolean consoleSwitch) {
            APPLogUtils.sLog2ConsoleSwitch = consoleSwitch;
            return this;
        }

        public Builder setGlobalTag(final String tag) {
            if (isSpace(tag)) {
                APPLogUtils.sGlobalTag = "";
                sTagIsSpace = true;
            } else {
                APPLogUtils.sGlobalTag = tag;
                sTagIsSpace = false;
            }
            return this;
        }
        ...
        public Builder setLogHeadSwitch(final boolean logHeadSwitch) {
            APPLogUtils.sLogHeadSwitch = logHeadSwitch;
            return this;
        }

        public Builder setLog2FileSwitch(final boolean log2FileSwitch) {
            APPLogUtils.sLog2FileSwitch = log2FileSwitch;
            return this;
        }

        public Builder setDir(final String dir) {
            if (isSpace(dir)) {
                APPLogUtils.dir = null;
            } else {
                APPLogUtils.dir = dir.endsWith(FILE_SEP) ? dir : dir + FILE_SEP;
            }
            return this;
        }

        public Builder setDir(final File dir) {
            APPLogUtils.dir = dir == null ? null : dir.getAbsolutePath() + FILE_SEP;
            return this;
        }

        public Builder setBorderSwitch(final boolean borderSwitch) {
            APPLogUtils.sLogBorderSwitch = borderSwitch;
            return this;
        }

        public Builder setConsoleFilter(@TYPE final int consoleFilter) {
            APPLogUtils.sConsoleFilter = consoleFilter;
            return this;
        }

        public Builder setFileFilter(@TYPE final int fileFilter) {
            APPLogUtils.sFileFilter = fileFilter;
            return this;
        }
    ...
    private static void log(final int type, final String tag, final Object... contents) {
        sLogSwitch = AppConstants.LOG_SWITCH;
