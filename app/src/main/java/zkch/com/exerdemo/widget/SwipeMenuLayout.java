...
public class SwipeMenuLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        //APPLogUtils.e(TAG, "onLayout() called with: " + "changed = [" + changed + "], l = [" + l + "], t = [" + t + "], r = [" + r + "], b = [" + b + "]");
        int childCount = getChildCount();
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        //APPLogUtils.d(TAG, "dispatchTouchEvent() called with: " + "ev = [" + ev + "]");
        if (isSwipeEnable) {
...
/*                    if (!mScroller.isFinished()) {
                ...
                case MotionEvent.ACTION_CANCEL:
                    ...
                    //APPLogUtils.i(TAG, "onTouch A ACTION_UP ACTION_CANCEL:velocityY:" + velocityX);
...
/*        mScroller.startScroll(getScrollX(), 0, -getScrollX(), 0);
        ...
        //APPLogUtils.d(TAG, "smoothClose() called with:getScrollX() " + getScrollX());
    }
