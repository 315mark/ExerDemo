package zkch.com.exerdemo.widget.smartrefresh;
...
public class ClassicsHeader extends RelativeLayout implements RefreshHeader {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if (ta.hasValue(R.styleable.ClassicsHeader_srlDrawableArrow)) {
            ...
            mArrowView.setImageResource(R.mipmap.refresh_rotate_arrow);
...
//            mProgressDrawable.setColor(0xff666666);
            mProgressDrawable.setColor(Color.parseColor("#999999"));
...
//            mTitleText.setTextSize(16);
        ...
        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTime)) {
            ...
            mLastUpdateText.setTextSize(TypedValue.COMPLEX_UNIT_SP,10);
